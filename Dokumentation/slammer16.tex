...
In der Informatik und der Robotik ist ein Bayes - Filter ein Verfahren verschiedene, Wahrscheinlichkeiten für die Position und Orientierung eines Roboters zu berechnen, befolgt von einer Aktualisierung der wahrscheinlichsten Position innerhalb einer Karte. Bayes - Filter sind im SLAM-kontext in Kalman- und Partikel - Filter unterschieden. 
...
Während unseren Experimenten haben wir uns auf ein eigenes Datenformat geeinigt. Jede Zeile stellt einen Scandurchlauf dar. Die erste Zahl gibt die Anzahl der darauf folgenden Messwerte wieder. Nach den Messwerten folgt die Odometrie mit 3 Werten: 
